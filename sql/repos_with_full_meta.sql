...
SELECT
  ...
  full_metadata.mirror_url AS mirror_url,
  ...
  full_metadata.watchers_count AS watchers_count,
  full_metadata.topics AS topics,
  full_metadata.stargazers_count AS stargazers_count,
  full_metadata.homepage AS homepage,
  ...
  full_metadata.score AS score,
  full_metadata.full_name AS full_name,
  full_metadata.has_issues AS has_issues,
  full_metadata.private AS private,
  sources,
  num_releases,
  num_contributors,
