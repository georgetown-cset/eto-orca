...
with DAG("ml_repo_etl",
    ...
    for metric_column in ["commits_count", "contributors_count", "forks_count", "open_issues_count", "releases_count",
                          "stargazers_count", "subscribers_count", "used_by_count"]:
