...
https://github.com/Open-Source-Software-Neighborhood-Watch/GitGeo/blob/d54b1fcd1a9f627e514b69eefc45e029d2fedd38/gitgeo/geographies_list.py
"""
...
with open(
    Path(__file__).with_name("world_cities.csv"), errors="ignore", newline=""
) as file:
